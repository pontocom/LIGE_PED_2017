            ...
            <div class="col-md-6">
                <form action="actualiza.php" method="post">
                    <div class="form-group">
                        <label>Nome</label>
                        <input class="form-control" name="nome" placeholder="Nome"  value="<?php echo $rs[0]["nome"]; ?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="telefone" placeholder="Telefone"  value="<?php echo $rs[0]["telefone"]; ?>">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputEmail1">Email</label>
                        <input class="form-control" name="email" placeholder="Email"  value="<?php echo $rs[0]["email"]; ?>">
                    </div>
